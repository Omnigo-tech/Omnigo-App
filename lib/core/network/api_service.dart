...
import 'package:grocery_app/data/models/favourite_response_model.dart';
import 'package:grocery_app/data/models/google_login_response_model.dart';
import 'package:grocery_app/data/models/onboarding_response_model.dart';
...
abstract class ApiService {
  ...
  Future<GoogleLoginResponse> googleLogin(@Body() Map<String, dynamic> body);
  ...
  Future<dynamic> saveManualLocation(@Body() Map<String, dynamic> body);

  @POST("auth/location/auto")
  Future<dynamic> saveAutoLocation(@Body() Map<String, dynamic> body);
