            ...
            Expanded(
              ...
              child: Column(
                children: [
                  _buildProgressBar(
                    DimensionsResources.INT_5,
                    DimensionsResources.D_1,
                  ),
                  _buildProgressBar(
                    DimensionsResources.INT_4,
                    DimensionsResources.D_0_7,
                  ),
                  _buildProgressBar(
                    DimensionsResources.INT_3,
                    DimensionsResources.D_0_4,
                  ),
                  _buildProgressBar(
                    DimensionsResources.INT_2,
                    DimensionsResources.D_0_2,
                  ),
                  _buildProgressBar(
                    DimensionsResources.INT_1,
                    DimensionsResources.D_0_0_5,
                  ),
                ],
              ),
            ),
